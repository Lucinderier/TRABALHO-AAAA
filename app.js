  ...
  usuarios.push({ nome: nomeDoUsuario, cpf: cpf, email: email, senha: senha, cargo: cargo });
    ...
    */
    ...
    const usuariosCadastrados = [
        { nome: "Leticia", cpf: "45454545454", email: "joao@email.com", senha: "senha111", cargo: "Gerente" },
        { nome: "Maria", cpf: "22222222222", email: "maria@email.com", senha: "senha456", cargo: "Vendedor" },
        { nome: "Carlos", cpf: "12121212121", email: "carlos@email.com", senha: "senha333", cargo: "Estoquista" },
        { nome: "Ana", cpf: "65656565656", email: "ana@email.com", senha: "senha444", cargo: "Vendedor" },
        { nome: "Pedro", cpf: "85858585858", email: "pedro@email.com", senha: "senha555", cargo: "Gerente" },
        { nome: "Sara", cpf: "78787878787", email: "sara@email.com", senha: "senha666", cargo: "Estoquista" }
    ];
...
function adicionarProduto() {
    ...
    const produtosPadaria = [
        ...
        { nome: "Donuts de morango", quantidade: 50, precoUnitario: 1.20 },
...
function validadeIndividual() {
    const produtosPadaria = [
        ...
        { nome: "Donuts de morango", quantidade: 50, precoUnitario: 1.20, validade: "2024-03-30" },
